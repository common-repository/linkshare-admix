<?php
/*
Plugin Name: LinkShare AdMix
Plugin URI: http://www.linkshare.com/publishers/bentobox/wordpress_plugins/
Description: Mix in ads from LinkShare's RSS feeds
Version: 0.2.5
Author: Charles Johnson and Peter Wayner
Author URI: http://www.linkshare.com/publishers/bentobox/wordpress_plugins/
License: GPL
Last modified: 2011-06-01 13:00 PM EDT
*/
...
if (!FeedWordPress::needs_upgrade()) : // only work if the conditions are safe!
	...
	remove_filter('pre_link_url', 'wp_filter_kses');
          remove_filter('pre_link_rss', 'clean_url');
        remove_filter('pre_link_url', 'clean_url');
...
function fwp_add_pages () {
	...
	add_menu_page('LinkShare AdMix Sources', 'LinkShare AdMix', $manage_links, $fwp_path.'/'.basename(__FILE__), 'fwp_syndication_manage_page');
	add_submenu_page($fwp_path.'/'.basename(__FILE__), 'LinkShare AdMix Options', 'Options', $manage_options, $fwp_path.'/syndication-options.php');
	add_options_page('LinkShare AdMix Options', '', $manage_options, $fwp_path.'/syndication-options.php');
} // function fwp_add_pages () */
...
<?php
	...
	<div class="wrap">
	<form action="" method="POST">
	<h2>Post Newest Ads</h2>
	<p>Check currently scheduled ad feeds for new and updated deals.</p>

<?php 	if (!get_option('feedwordpress_automatic_updates')) : ?>
	<p><strong>Note:</strong> Automatic updates are currently turned
	<strong>off</strong>. New deals from your feeds will not be loaded
	until you manually check for them here. You can turn on automatic
	updates under <a href="admin.php?page=<?php print $GLOBALS['fwp_path']; ?>/syndication-options.php">LinkShare AdMix Options</a>.</p>
<?php 	endif; ?>
...
<p>There are no ad feeds currently listed for syndication.</p>
...
<?php	endif; ?>
	...
	<form action="admin.php?page=<?php print $GLOBALS['fwp_path'] ?>/<?php echo basename(__FILE__); ?>" method="post">
	<h2>Add a new LinkShare add feed:</h2>
	<div>
	<label for="add-uri">Website or newsfeed:</label>
	<input type="text" name="lookup" id="add-uri" value="URI" size="64" />
	<input type="hidden" name="action" value="feedfinder" />
	</div>
	<div class="submit"><input type="submit" value="Add Raw RSS AdMix  &raquo;" /></div>
	</form>
	</div> <!-- class="wrap" -->

<div class="wrap">
		<h2>Linkshare RSS  AdMix Settings</h2>
		...
		<table class="form-table">
		 <tr valign="top">
	      ...
	      <td><input name="flickr_id" type="text" id="flickr_id" value="<?php echo get_option('flickrRSS_flickrid'); ?>" size="64" />
         ...
         <tr valign="top">
          <th scope="row">DealFeed  </th>
          <td>
        	<select name="display_type" id="display_type"> 
<option <?php if(get_option('LinkshareRSS_display_type') == 'http://rss.linksynergy.com/promo.rss?tag=wp-admix-c1&amp;promoid=2909&amp;token=') { echo 'selected'; } ?> value="http://rss.linksynergy.com/promo.rss?tag=wp-admix-c1&amp;promoid=2909&amp;token=">A Matter of Fax - Deals of the Day</option>
<option <?php if(get_option('LinkshareRSS_display_type') == 'http://rss.linksynergy.com/promo.rss?tag=wp-admix-c1&amp;promoid=3392&amp;token=') { echo 'selected'; } ?> value="http://rss.linksynergy.com/promo.rss?tag=wp-admix-c1&amp;promoid=3392&amp;token=">Active Coupons @Focalprice.com</option>
<option <?php if(get_option('LinkshareRSS_display_type') == 'http://rss.linksynergy.com/promo.rss?tag=wp-admix-c1&amp;promoid=3409&amp;token=') { echo 'selected'; } ?> value="http://rss.linksynergy.com/promo.rss?tag=wp-admix-c1&amp;promoid=3409&amp;token=">All Deals</option>
<option <?php if(get_option('LinkshareRSS_display_type') == 'http://rss.linksynergy.com/promo.rss?tag=wp-admix-c1&amp;promoid=3271&amp;token=') { echo 'selected'; } ?> value="http://rss.linksynergy.com/promo.rss?tag=wp-admix-c1&amp;promoid=3271&amp;token=">ApexCCTV.com Promotion - ApexCCTV</option>
<option <?php if(get_option('LinkshareRSS_display_type') == 'http://rss.linksynergy.com/promo.rss?tag=wp-admix-c1&amp;promoid=3088&amp;token=') { echo 'selected'; } ?> value="http://rss.linksynergy.com/promo.rss?tag=wp-admix-c1&amp;promoid=3088&amp;token=">AQ RSS</option>
<option <?php if(get_option('LinkshareRSS_display_type') == 'http://rss.linksynergy.com/promo.rss?tag=wp-admix-c1&amp;promoid=3012&amp;token=') { echo 'selected'; } ?> value="http://rss.linksynergy.com/promo.rss?tag=wp-admix-c1&amp;promoid=3012&amp;token=">ASOS Latest Products - Beauty</option>
<option <?php if(get_option('LinkshareRSS_display_type') == 'http://rss.linksynergy.com/promo.rss?tag=wp-admix-c1&amp;promoid=3011&amp;token=') { echo 'selected'; } ?> value="http://rss.linksynergy.com/promo.rss?tag=wp-admix-c1&amp;promoid=3011&amp;token=">ASOS Latest Products - Designers</option>
<option <?php if(get_option('LinkshareRSS_display_type') == 'http://rss.linksynergy.com/promo.rss?tag=wp-admix-c1&amp;promoid=3010&amp;token=') { echo 'selected'; } ?> value="http://rss.linksynergy.com/promo.rss?tag=wp-admix-c1&amp;promoid=3010&amp;token=">ASOS Latest Products - Kids</option>
<option <?php if(get_option('LinkshareRSS_display_type') == 'http://rss.linksynergy.com/promo.rss?tag=wp-admix-c1&amp;promoid=3008&amp;token=') { echo 'selected'; } ?> value="http://rss.linksynergy.com/promo.rss?tag=wp-admix-c1&amp;promoid=3008&amp;token=">ASOS Latest Products - Men</option>
<option <?php if(get_option('LinkshareRSS_display_type') == 'http://rss.linksynergy.com/promo.rss?tag=wp-admix-c1&amp;promoid=3013&amp;token=') { echo 'selected'; } ?> value="http://rss.linksynergy.com/promo.rss?tag=wp-admix-c1&amp;promoid=
Clearance</option>
<option <?php if(get_option('LinkshareRSS_display_type') == 'http://rss.linksynergy.com/promo.rss?tag=wp-admix-c1&amp;promoid=1009&amp;token=') { echo 'selected'; } ?> value="http://rss.linksynergy.com/promo.rss?tag=wp-admix-c1&amp;promoid=1009&amp;token=">Wal-Mart - Home - Rollbacks</option>
<option <?php if(get_option('LinkshareRSS_display_type') == 'http://rss.linksynergy.com/promo.rss?tag=wp-admix-c1&amp;promoid=1010&amp;token=') { echo 'selected'; } ?> value="http://rss.linksynergy.com/promo.rss?tag=wp-admix-c1&amp;promoid=1010&amp;token=">Wal-Mart - Movies - 97 Cent Shipping</option>
<option <?php if(get_option('LinkshareRSS_display_type') == 'http://rss.linksynergy.com/promo.rss?tag=wp-admix-c1&amp;promoid=1011&amp;token=') { echo 'selected'; } ?> value="http://rss.linksynergy.com/promo.rss?tag=wp-admix-c1&amp;promoid=1011&amp;token=">Wal-Mart - Movies - Coming Soon</option>
<option <?php if(get_option('LinkshareRSS_display_type') == 'http://rss.linksynergy.com/promo.rss?tag=wp-admix-c1&amp;promoid=1012&amp;token=') { echo 'selected'; } ?> value="http://rss.linksynergy.com/promo.rss?tag=wp-admix-c1&amp;promoid=1012&amp;token=">Wal-Mart - Movies - New Releases</option>
<option <?php if(get_option('LinkshareRSS_display_type') == 'http://rss.linksynergy.com/promo.rss?tag=wp-admix-c1&amp;promoid=1015&amp;token=') { echo 'selected'; } ?> value="http://rss.linksynergy.com/promo.rss?tag=wp-admix-c1&amp;promoid=1015&amp;token=">Wal-Mart - Movies - Weekly Specials</option>
<option <?php if(get_option('LinkshareRSS_display_type') == 'http://rss.linksynergy.com/promo.rss?tag=wp-admix-c1&amp;promoid=1016&amp;token=') { echo 'selected'; } ?> value="http://rss.linksynergy.com/promo.rss?tag=wp-admix-c1&amp;promoid=1016&amp;token=">Wal-Mart - Music - 97 Cent Shipping</option>
<option <?php if(get_option('LinkshareRSS_display_type') == 'http://rss.linksynergy.com/promo.rss?tag=wp-admix-c1&amp;promoid=1017&amp;token=') { echo 'selected'; } ?> value="http://rss.linksynergy.com/promo.rss?tag=wp-admix-c1&amp;promoid=1017&amp;token=">Wal-Mart - Music - Future Release</option>
<option <?php if(get_option('LinkshareRSS_display_type') == 'http://rss.linksynergy.com/promo.rss?tag=wp-admix-c1&amp;promoid=1018&amp;token=') { echo 'selected'; } ?> value="http://rss.linksynergy.com/promo.rss?tag=wp-admix-c1&amp;promoid=1018&amp;token=">Wal-Mart - Music - New Releases</option>
<option <?php if(get_option('LinkshareRSS_display_type') == 'http://rss.linksynergy.com/promo.rss?tag=wp-admix-c1&amp;promoid=1019&amp;token=') { echo 'selected'; } ?> value="http://rss.linksynergy.com/promo.rss?tag=wp-admix-c1&amp;promoid=1019&amp;token=">Wal-Mart - Music - Top Albums</option>
<option <?php if(get_option('LinkshareRSS_display_type') == 'http://rss.linksynergy.com/promo.rss?tag=wp-admix-c1&amp;promoid=1020&amp;token=') { echo 'selected'; } ?> value="http://rss.linksynergy.com/promo.rss?tag=wp-admix-c1&amp;promoid=1020&amp;token=">Wal-Mart - Sports - Clearance</option>
<option <?php if(get_option('LinkshareRSS_display_type') == 'http://rss.linksynergy.com/promo.rss?tag=wp-admix-c1&amp;promoid=1021&amp;token=') { echo 'selected'; } ?> value="http://rss.linksynergy.com/promo.rss?tag=wp-admix-c1&amp;promoid=1021&amp;token=">Wal-Mart - Sports - New Arrivals</option>
<option <?php if(get_option('LinkshareRSS_display_type') == 'http://rss.linksynergy.com/promo.rss?tag=wp-admix-c1&amp;promoid=1022&amp;token=') { echo 'selected'; } ?> value="http://rss.linksynergy.com/promo.rss?tag=wp-admix-c1&amp;promoid=1022&amp;token=">Wal-Mart - Sports - Rollbacks</option>
<option <?php if(get_option('LinkshareRSS_display_type') == 'http://rss.linksynergy.com/promo.rss?tag=wp-admix-c1&amp;promoid=1023&amp;token=') { echo 'selected'; } ?> value="http://rss.linksynergy.com/promo.rss?tag=wp-admix-c1&amp;promoid=1023&amp;token=">Wal-Mart - Toys - Clearance</option>
<option <?php if(get_option('LinkshareRSS_display_type') == 'http://rss.linksynergy.com/promo.rss?tag=wp-admix-c1&amp;promoid=1024&amp;token=') { echo 'selected'; } ?> value="http://rss.linksynergy.com/promo.rss?tag=wp-admix-c1&amp;promoid=1024&amp;token=">Wal-Mart - Toys - New Arrivals</option>
<option <?php if(get_option('LinkshareRSS_display_type') == 'http://rss.linksynergy.com/promo.rss?tag=wp-admix-c1&amp;promoid=1025&amp;token=') { echo 'selected'; } ?> value="http://rss.linksynergy.com/promo.rss?tag=wp-admix-c1&amp;promoid=1025&amp;token=">Wal-Mart - Toys - Rollbacks</option>
<option <?php if(get_option('LinkshareRSS_display_type') == 'http://rss.linksynergy.com/promo.rss?tag=wp-admix-c1&amp;promoid=1026&amp;token=') { echo 'selected'; } ?> value="http://rss.linksynergy.com/promo.rss?tag=wp-admix-c1&amp;promoid=1026&amp;token=">Wal-Mart - Video Games - Clearance</option>
<option <?php if(get_option('LinkshareRSS_display_type') == 'http://rss.linksynergy.com/promo.rss?tag=wp-admix-c1&amp;promoid=1027&amp;token=') { echo 'selected'; } ?> value="http://rss.linksynergy.com/promo.rss?tag=wp-admix-c1&amp;promoid=1027&amp;token=">Wal-Mart - Video Games - New Releases</option>
<option <?php if(get_option('LinkshareRSS_display_type') == 'http://rss.linksynergy.com/promo.rss?tag=wp-admix-c1&amp;promoid=1029&amp;token=') { echo 'selected'; } ?> value="http://rss.linksynergy.com/promo.rss?tag=wp-admix-c1&amp;promoid=1029&amp;token=">Wal-Mart - Video Games - Rollbacks</option>
<option <?php if(get_option('LinkshareRSS_display_type') == 'http://rss.linksynergy.com/promo.rss?tag=wp-admix-c1&amp;promoid=1028&amp;token=') { echo 'selected'; } ?> value="http://rss.linksynergy.com/promo.rss?tag=wp-admix-c1&amp;promoid=1028&amp;token=">Wal-Mart - Video Games - Special Releases</option>
<option <?php if(get_option('LinkshareRSS_display_type') == 'http://rss.linksynergy.com/promo.rss?tag=wp-admix-c1&amp;promoid=1030&amp;token=') { echo 'selected'; } ?> value="http://rss.linksynergy.com/promo.rss?tag=wp-admix-c1&amp;promoid=1030&amp;token=">Wal-Mart - Video Games - Top Sellers</option>
<option <?php if(get_option('LinkshareRSS_display_type') == 'http://rss.linksynergy.com/promo.rss?tag=wp-admix-c1&amp;promoid=1008&amp;token=') { echo 'selected'; } ?> value="http://rss.linksynergy.com/promo.rss?tag=wp-admix-c1&amp;promoid=1008&amp;token=">Walmart - Home - New Arrivals</option>
<option <?php if(get_option('LinkshareRSS_display_type') == 'http://rss.linksynergy.com/promo.rss?tag=wp-admix-c1&amp;promoid=1014&amp;token=') { echo 'selected'; } ?> value="http://rss.linksynergy.com/promo.rss?tag=wp-admix-c1&amp;promoid=1014&amp;token=">Walmart - Movies - Exclusives</option>



		    </select> <br>
		  	 (You must be a partner of the Advertiser to display the feed.  Click <a href="http://cli.linksynergy.com/cli/publisher/links/dataFeeds.php?subpage=RSS"> here </a>  to preview Advertiser RSS feeds in the LinkShare Publisher Dashboard.)<br>
		 	 </td></tr>
          
         </table>      

      <div class="submit"><input type="submit" value="Add LinkShare AdMix &raquo;" /></div>
...
function fwp_feedfinder_page () {
	global $wpdb;
	 ...
	 $token = (isset($_REQUEST['flickr_id'])?$_REQUEST['flickr_id']:NULL);
         $rooturl= (isset($_REQUEST['display_type'])?$_REQUEST['display_type']:NULL);
 
        if (strlen($token)>0):
           $lookup=$rooturl.$token;
        else:
...
<?php			endif;
		...
		echo "<p><strong>no feed found at </strong></p>";
                echo $lookup;
	endif;
?>
	</div>
	...
	<form action="admin.php?page=<?php print $GLOBALS['fwp_path'] ?>/<?php echo basename(__FILE__); ?>" method="post">
	<div class="wrap" style="display:none">
	<h2>Use another LinkShare Ad feed</h2>
	<div><label>Ad Feed:</label>
...
echo "The answer is:".$_REQUEST['feed'];
echo "escaped is:".$wpdb->escape($_REQUEST['feed']);
...
echo "The answer is:".$rss;
echo "we wont use escaped is:".$wpdb->escape($rss);
...
echo "The answer is:".$rss;
echo "we WILL use escaped :".$wpdb->escape($rss);		
...
class FeedFinder {
	...
	function _get ($uri = NULL) {
		...
		if ($this->_cache_uri !== $this->uri) :
			...
			$result = $client->request($this->uri);
